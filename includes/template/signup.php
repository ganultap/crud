<div class="card mt-2 mb-2 small shadow-lg border border-info">
    ...
    <div class="card-body bg-white shadow-lg small">
        ...
        <?php
                ...
                ?>
        <form method="post" action="transactions/register.php" enctype="multipart/form-data" class="needs-validation p-10" novalidate>
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-12 mb-2">
                    ...
                    <input type="text" name="email" class="form-control" placeholder="john.doe@example.com" required>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 mb-2">
                ...
                <div class="col-sm-12 mt-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                                <input type="file" name="avatar" id="imgInp" accept="image/*" required />
                        </div>
                    </div>
                </div>
            </div>

      ...
      include("../includes/template/footer.php");
         ...
         if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            foreach ($myArr as $value) {
                if ($value == 1){
                  $result =  ('<h5><span style="color:#FF5733;">Registration Failed: Invalid Input(s)</span></h5>');
                     break;
                }
                else {
                  $result =  ('<h5><span style="color:#239B56;">Congratulations! Registration Successful.</span></h5>');
                }
             }
